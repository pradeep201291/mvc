...
{ 
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            LoginModel _model = new LoginModel() { IsConfirmed = true };
            return View(_model);
        }
        ...
        {
            bool authenticate = Authentication(model.UserName, model.Password);
            if(authenticate)
            {
        ...
        //        try
        //        {
        //            string confirmationtoken=WebSecurity.CreateUserAndAccount(model.UserName, model.Password,model.Email,true);
        ...
        //    {
        //        return RedirectToAction("Confirmation Success!!!!");
        //    }
        //    return RedirectToAction("Confirmation Failure!!!!");
        //}
        ...
        //    }
        //    return RedirectToAction("Invalid UserName");
        //}
